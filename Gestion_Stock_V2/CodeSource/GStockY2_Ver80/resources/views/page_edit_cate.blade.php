        ...
        @if(session()->has('utilisateur') && session('utilisateur.role.id_Role') == 1)
            @if(isset($cate_data))
                <div class="page_role_div">
                    ...
                    <div class="dparb">
                        <div class="form_div">
                        <form class="form_item" method="Post" action="{{ route('_cate_.update', $cate_data->id_categorie) }}">
                                ...
                                <div class="Div_role_name Div_email">
                                        ...
                                        <input min="4" class="input_lable Input_item input_lable_s_btn" type="text" name="nom" id="nom" placeholder="Entrer le nom de Catégorie" value="{{ $cate_data -> nom }}">
                                        @if ($errors->has('nom'))
                                    ...
                                    <div class="Div_description_role Div_email Div_password">
                                        ...
                                        <input class="input_lable Input_item input_lable_s_btn" type="text" name="description" id="role_description" placeholder="Entrer La description de Catégorie" value="{{ $cate_data->description }}">
            ...
            @else
                <p>Il y a aucune donee pour Catégorie.</p>
            @endif
        @else
